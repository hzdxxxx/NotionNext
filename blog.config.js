...
const BLOG = {
  ...
  BIO: process.env.NEXT_PUBLIC_BIO || '复旦国际经济学本科→NTU管理经济学在读丨人生是一场思考下的无尽冒险', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://notion-next-obbo.vercel.app', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '思考记录, blog', // 网站关键词 英文逗号隔开
